    ...
    <div class="form-container">
      ...
      <form class="form" action="registration" method="POST">
        ...
        <div class="checkboxes-container">
          <div class="checkbox">
            <input type="checkbox" onchange="formSubmit()" id="safety_policy" name="safety_policy" class="checkboxes" style="height: 20px; width: 20px; margin-right: 10px"> I agree with<a href="/safety_policy" style="color: dodgerblue; padding-left: 7px">safety policy</a>
          </div>
          <div class="checkbox">
        ...
        <a href="/sign_in" class="link-registration">Already have an account? Sign in</a>
